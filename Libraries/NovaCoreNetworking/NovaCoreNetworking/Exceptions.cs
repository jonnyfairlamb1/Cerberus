...
namespace NovaCoreNetworking {
    ...
    /// <summary>
    /// The exception that is thrown when a <see cref="Message"/> does not contain enough unread
    ...
    public class InsufficientCapacityException : Exception {
        ...
        /// </summary>
        public readonly Message NovaCoreNetworkingMessage;
        ...
        /// <summary>
        /// Initializes a new <see cref="InsufficientCapacityException"/> instance.
        /// </summary>
        public InsufficientCapacityException() { }

        /// <summary>
        /// Initializes a new <see cref="InsufficientCapacityException"/> instance with a specified
        /// error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="InsufficientCapacityException"/> instance and constructs an
        ...
        public InsufficientCapacityException(Message message, string typeName, int requiredBytes) : base(GetErrorMessage(message, typeName, requiredBytes)) {
            NovaCoreNetworkingMessage = message;
    ...
    /// <summary>
    /// The exception that is thrown when a method with a <see cref="MessageHandlerAttribute"/> is
    ...
    public class NonStaticHandlerException : Exception {
        ...
        /// <summary>
        /// Initializes a new <see cref="NonStaticHandlerException"/> instance.
        /// </summary>
        public NonStaticHandlerException() { }

        /// <summary>
        /// Initializes a new <see cref="NonStaticHandlerException"/> instance with a specified
        /// error message.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        ...
        /// <summary>
        /// Initializes a new <see cref="NonStaticHandlerException"/> instance and constructs an
        /// error message from the given information.
        /// </summary>
    ...
    /// <summary>
    /// The exception that is thrown when a method with a <see cref="MessageHandlerAttribute"/> does
    /// not have an acceptable message handler method signature (either <see
    /// cref="Server.MessageHandler"/> or <see cref="Client.MessageHandler"/>).
    /// </summary>
    public class InvalidHandlerSignatureException : Exception {
        ...
        /// <summary>
        /// Initializes a new <see cref="InvalidHandlerSignatureException"/> instance.
        /// </summary>
        public InvalidHandlerSignatureException() { }

        /// <summary>
        /// Initializes a new <see cref="InvalidHandlerSignatureException"/> instance with a
        ...
        /// <summary>
        /// Initializes a new <see cref="InvalidHandlerSignatureException"/> instance and constructs
        ...
        /// <returns>The error message.</returns>
        private static string GetErrorMessage(Type declaringType, string handlerMethodName) {
            return $"'{declaringType.Name}.{handlerMethodName}' doesn't match any acceptable message handler method signatures! Server message handler methods should have a 'ushort' and a '{nameof(NovaCoreNetworking.Message)}' parameter, while client message handler methods should only have a '{nameof(NovaCoreNetworking.Message)}' parameter.";
        }
    }

    /// <summary>
    /// The exception that is thrown when multiple methods with <see
    /// cref="MessageHandlerAttribute"/> s are set to handle messages with the same ID <i>and</i>
    ...
    public class DuplicateHandlerException : Exception {
        ...
        /// <summary>
        /// Initializes a new <see cref="DuplicateHandlerException"/> instance with a specified
        /// error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="DuplicateHandlerException"/> instance and constructs an
        /// error message from the given information.
        /// </summary>
