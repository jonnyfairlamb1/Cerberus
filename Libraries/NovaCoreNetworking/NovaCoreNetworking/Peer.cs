...
namespace NovaCoreNetworking {
    ...
    /// <summary>
    /// Provides base functionality for <see cref="Server"/> and <see cref="Client"/>.
    /// </summary>
    public abstract class Peer {

        /// <summary>
        /// The name to use when logging messages via <see cref="NovaCoreLogger"/>.
        /// </summary>
        ...
        /// <summary>
        /// The number of currently active <see cref="Server"/> and <see cref="Client"/> instances.
        /// </summary>
        ...
        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.NeverConnected"/>.
        /// </summary>
        protected const string DCNeverConnected = "Never connected";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.TransportError"/>.
        /// </summary>
        protected const string DCTransportError = "Transport error";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.TimedOut"/>.
        /// </summary>
        protected const string DCTimedOut = "Timed out";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.Kicked"/>.
        /// </summary>
        protected const string DCKicked = "Kicked";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.ServerStopped"/>.
        /// </summary>
        protected const string DCServerStopped = "Server stopped";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.Disconnected"/>.
        /// </summary>
        ...
        /// <summary>
        /// The text to log when the connection failed due to <see cref="RejectReason.NoConnection"/>.
        /// </summary>
        protected const string CRNoConnection = "No connection";

        /// <summary>
        /// The text to log when the connection failed due to <see cref="RejectReason.ServerFull"/>.
        /// </summary>
        protected const string CRServerFull = "Server is full";

        /// <summary>
        /// The text to log when the connection failed due to <see cref="RejectReason.Rejected"/>.
        /// </summary>
        protected const string CRRejected = "Rejected";

        /// <summary>
        /// The text to log when the connection failed due to <see cref="RejectReason.Custom"/>.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves methods marked with <see cref="MessageHandlerAttribute"/>.
        /// </summary>
        ...
        /// <summary>
        /// Increases <see cref="ActiveCount"/>. For use when a new <see cref="Server"/> or <see
        /// cref="Client"/> is started.
        /// </summary>
        ...
        /// <summary>
        /// Decreases <see cref="ActiveCount"/>. For use when a <see cref="Server"/> or <see
        /// cref="Client"/> is stopped.
        /// </summary>
