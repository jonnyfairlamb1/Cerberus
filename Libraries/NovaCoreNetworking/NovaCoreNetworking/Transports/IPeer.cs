...
namespace NovaCoreNetworking.Transports {

    /// <summary>
    /// The header type of a <see cref="Message"/>.
    /// </summary>
    public enum MessageHeader : byte {
        ...
        /// <summary>
        /// An internal unreliable ack message, used when acknowledging a sequence ID other than the
        /// last received one.
        /// </summary>
        AckExtra,
