...
namespace NovaCoreNetworking.Transports.Tcp {

    /// <summary>
    /// A client which can connect to a <see cref="TcpServer"/>.
    /// </summary>
    public class TcpClient : TcpPeer, IClient {
        ...
        public bool Connect(string hostAddress, out Connection connection, out string connectError) {
            ...
            try {
                ...
                // call OnConnected(), and let NovaCoreNetworking detect that no connection was established.
            }
