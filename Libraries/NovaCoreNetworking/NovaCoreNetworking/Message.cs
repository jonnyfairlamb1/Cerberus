using NovaCoreNetworking.Transports;
...
namespace NovaCoreNetworking {
    ...
    /// <summary>
    /// The send mode of a <see cref="Message"/>.
    /// </summary>
    ...
    public class Message {
        ...
        /// </summary>
        /// <remarks>
        /// 1 byte for the actual header, 2 bytes for the sequence ID (only for reliable messages),
        /// 2 bytes for the message ID. Messages sent unreliably will use 2 bytes less than this
        /// value for the header.
        /// </remarks>
        public const int MaxHeaderSize = 5;

        /// <summary>
        /// The maximum number of bytes that a message can contain, including the <see cref="MaxHeaderSize"/>.
        /// </summary>
        ...
        /// represents how many bytes can be added to a message <i>on top of</i> the <see cref="MaxHeaderSize"/>.
        /// </summary>
        public static int MaxPayloadSize {
            get => MaxSize - MaxHeaderSize;
            set {
                if (Peer.ActiveCount > 0)
                    NovaCoreLogger.Log(LogType.Error, $"Changing the max message size is not allowed while a {nameof(Server)} or {nameof(Client)} is running!");
                else {
                    if (value < 0) {
                        NovaCoreLogger.Log(LogType.Error, $"The max payload size cannot be negative! Setting it to 0 instead of the given value ({value}).");
        ...
        /// <summary>
        /// How many messages to add to the pool for each <see cref="Server"/> or <see
        /// cref="Client"/> instance that is started.
        /// </summary>
        /// <remarks>
        /// Changes will not affect <see cref="Server"/> and <see cref="Client"/> instances which
        ...
        /// <summary>
        /// Initializes a reusable <see cref="Message"/> instance.
        /// </summary>
        ...
        /// and/or <see cref="Client"/> instances are currently running.
        /// </summary>
        public static void TrimPool() {
            if (Peer.ActiveCount == 0) {
                ...
                // Reset the pool capacity and number of Message instances in the pool to what is
                // appropriate for how many Servers & Clients are active
        ...
        /// <remarks>
        /// NOTE: <paramref name="id"/> will be cast to a <see cref="ushort"/>. You should ensure
        /// that its value never exceeds that of <see cref="ushort.MaxValue"/>, otherwise you'll
        /// encounter unexpected behaviour when handling messages.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// As this message instance is returned straight from the pool, it will contain all
        /// previous data and settings. Using this instance without preparing it properly will
        /// likely result in unexpected behaviour.
        /// </remarks>
        ...
        /// appropriate <see cref="MessageSendMode"/> and read/write positions.
        /// </summary>
        ...
        /// <summary>
        /// Adds a single <see cref="byte"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Adds a single <see cref="sbyte"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a single <see cref="byte"/> from the message.
        /// </summary>
        /// <returns>The <see cref="byte"/> that was retrieved.</returns>
        public byte GetByte() {
            if (UnreadLength < 1) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(ByteName));
                return 0;
            }
        ...
        /// <summary>
        /// Retrieves a single <see cref="sbyte"/> from the message.
        /// </summary>
        /// <returns>The <see cref="sbyte"/> that was retrieved.</returns>
        public sbyte GetSByte() {
            if (UnreadLength < 1) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(SByteName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds a <see cref="byte"/> array to the message.
        /// </summary>
        ...
        /// <summary>
        /// Adds an <see cref="sbyte"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="byte"/> array from the message.
        /// </summary>
        ...
        /// <summary>
        /// Populates a <see cref="byte"/> array with bytes retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of bytes to retrieve.</param>
        ...
        /// <summary>
        /// Retrieves an <see cref="sbyte"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="sbyte"/> array with bytes retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of sbytes to retrieve.</param>
        ...
        private void ReadBytes(int amount, byte[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ByteName));
                amount = UnreadLength;
            }
        ...
        private void ReadSBytes(int amount, sbyte[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, SByteName));
                amount = UnreadLength;
            }
        ...
        /// <summary>
        /// Adds a <see cref="bool"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="bool"/> from the message.
        /// </summary>
        /// <returns>The <see cref="bool"/> that was retrieved.</returns>
        public bool GetBool() {
            if (UnreadLength < sizeof(bool)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(BoolName, "false"));
                return false;
            }
        ...
        /// <summary>
        /// Adds a <see cref="bool"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="bool"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        public bool[] GetBools(int amount) {
            ...
            if (UnreadLength < byteAmount) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(array.Length, BoolName));
        ...
        /// <summary>
        /// Populates a <see cref="bool"/> array with bools retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of bools to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        public void GetBools(int amount, bool[] intoArray, int startIndex = 0) {
            ...
            int byteAmount = amount / 8 + (amount % 8 == 0 ? 0 : 1);
            if (UnreadLength < byteAmount)
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, BoolName));
        ...
        /// <summary>
        /// Adds a <see cref="short"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="ushort"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="short"/> from the message.
        /// </summary>
        /// <returns>The <see cref="short"/> that was retrieved.</returns>
        public short GetShort() {
            if (UnreadLength < sizeof(short)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(ShortName));
                return 0;
            }
        ...
        /// <summary>
        /// Retrieves a <see cref="ushort"/> from the message.
        /// </summary>
        /// <returns>The <see cref="ushort"/> that was retrieved.</returns>
        public ushort GetUShort() {
            if (UnreadLength < sizeof(ushort)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(UShortName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds a <see cref="short"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Adds a <see cref="ushort"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="short"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="short"/> array with shorts retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of shorts to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        /// <summary>
        /// Retrieves a <see cref="ushort"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="ushort"/> array with ushorts retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of ushorts to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private void ReadShorts(int amount, short[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(short)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ShortName));
        ...
        private void ReadUShorts(int amount, ushort[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(ushort)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, UShortName));
                amount = UnreadLength / sizeof(short);
            }
        ...
        /// <summary>
        /// Adds an <see cref="int"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="uint"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves an <see cref="int"/> from the message.
        /// </summary>
        /// <returns>The <see cref="int"/> that was retrieved.</returns>
        public int GetInt() {
            if (UnreadLength < sizeof(int)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(IntName));
                return 0;
            }
        ...
        /// <summary>
        /// Retrieves a <see cref="uint"/> from the message.
        /// </summary>
        /// <returns>The <see cref="uint"/> that was retrieved.</returns>
        public uint GetUInt() {
            if (UnreadLength < sizeof(uint)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(UIntName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds an <see cref="int"/> array message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Adds a <see cref="uint"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves an <see cref="int"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates an <see cref="int"/> array with ints retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of ints to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        /// <summary>
        /// Retrieves a <see cref="uint"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="uint"/> array with uints retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of uints to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private void ReadInts(int amount, int[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(int)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, IntName));
        ...
        private void ReadUInts(int amount, uint[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(uint)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, UIntName));
        ...
        /// <summary>
        /// Adds a <see cref="long"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="ulong"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="long"/> from the message.
        /// </summary>
        /// <returns>The <see cref="long"/> that was retrieved.</returns>
        public long GetLong() {
            if (UnreadLength < sizeof(long)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(LongName));
                return 0;
            }
        ...
        /// <summary>
        /// Retrieves a <see cref="ulong"/> from the message.
        /// </summary>
        /// <returns>The <see cref="ulong"/> that was retrieved.</returns>
        public ulong GetULong() {
            if (UnreadLength < sizeof(ulong)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(ULongName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds a <see cref="long"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Adds a <see cref="ulong"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="long"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="long"/> array with longs retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of longs to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        /// <summary>
        /// Retrieves a <see cref="ulong"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="ulong"/> array with ulongs retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of ulongs to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private void ReadLongs(int amount, long[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(long)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, LongName));
        ...
        private void ReadULongs(int amount, ulong[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(ulong)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ULongName));
        ...
        /// <summary>
        /// Adds a <see cref="float"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="float"/> from the message.
        /// </summary>
        /// <returns>The <see cref="float"/> that was retrieved.</returns>
        public float GetFloat() {
            if (UnreadLength < sizeof(float)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(FloatName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds a <see cref="float"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="float"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="float"/> array with floats retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of floats to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private void ReadFloats(int amount, float[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(float)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, FloatName));
        ...
        /// <summary>
        /// Adds a <see cref="double"/> to the message.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="double"/> from the message.
        /// </summary>
        /// <returns>The <see cref="double"/> that was retrieved.</returns>
        public double GetDouble() {
            if (UnreadLength < sizeof(double)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(DoubleName));
                return 0;
            }
        ...
        /// <summary>
        /// Adds a <see cref="double"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        /// <summary>
        /// Retrieves a <see cref="double"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="double"/> array with doubles retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of doubles to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private void ReadDoubles(int amount, double[] intoArray, int startIndex = 0) {
            if (UnreadLength < amount * sizeof(double)) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, DoubleName));
        ...
        /// <summary>
        /// Retrieves a <see cref="string"/> from the message.
        /// </summary>
        ...
        public string GetString() {
            ...
            if (UnreadLength < length) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(StringName, "shortened string"));
        ...
        /// <summary>
        /// Adds a <see cref="string"/> array to the message.
        /// </summary>
        /// <param name="array">The array to add.</param>
        /// <param name="includeLength">
        /// Whether or not to include the length of the array in the message.
        ...
        public Message AddStrings(string[] array, bool includeLength = true) {
            ...
            // It'd be ideal to throw an exception here (instead of in AddString) if the entire
            // array isn't going to fit, but since each string could be (and most likely is) a
            // different length and some characters use more than a single byte, the only way of
            // doing that would be to loop through the whole array here and convert each string to
            // bytes ahead of time, just to get the required byte count. Then if they all fit into
            // the message, they would all be converted again when actually being written into the
            // byte array, which is obviously inefficient.
        ...
        /// <summary>
        /// Retrieves a <see cref="string"/> array from the message.
        /// </summary>
        /// <returns>The array that was retrieved.</returns>
        ...
        /// <summary>
        /// Populates a <see cref="string"/> array with strings retrieved from the message.
        /// </summary>
        /// <param name="amount">The amount of strings to retrieve.</param>
        /// <param name="intoArray">The array to populate.</param>
        /// <param name="startIndex">The position at which to start populating the array.</param>
        ...
        private ushort GetArrayLength() {
            if (UnreadLength < 1) {
                NovaCoreLogger.Log(LogType.Error, NotEnoughBytesError(ArrayLengthName));
                return 0;
            }
        ...
        #endregion IMessageSerializable Types
        ...
        /// <remarks>
        /// This method is simply an alternative way of calling <see cref="AddDoubles(double[], bool)"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This method is simply an alternative way of calling <see cref="AddStrings(string[], bool)"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This method is simply an alternative way of calling <see cref="AddSerializables{T}(T[], bool)"/>.
        /// </remarks>
        ...
        #endregion Overload Versions

        #endregion Add & Retrieve Data

        #region Error Messaging

        /// <summary>
        /// The name of a <see cref="byte"/> value.
        /// </summary>
        private const string ByteName = "byte";

        /// <summary>
        /// The name of a <see cref="sbyte"/> value.
        /// </summary>
        private const string SByteName = "sbyte";

        /// <summary>
        /// The name of a <see cref="bool"/> value.
        /// </summary>
        private const string BoolName = "bool";

        /// <summary>
        /// The name of a <see cref="short"/> value.
        /// </summary>
        private const string ShortName = "short";

        /// <summary>
        /// The name of a <see cref="ushort"/> value.
        /// </summary>
        private const string UShortName = "ushort";

        /// <summary>
        /// The name of an <see cref="int"/> value.
        /// </summary>
        private const string IntName = "int";

        /// <summary>
        /// The name of a <see cref="uint"/> value.
        /// </summary>
        private const string UIntName = "uint";

        /// <summary>
        /// The name of a <see cref="long"/> value.
        /// </summary>
        private const string LongName = "long";

        /// <summary>
        /// The name of a <see cref="ulong"/> value.
        /// </summary>
        private const string ULongName = "ulong";

        /// <summary>
        /// The name of a <see cref="float"/> value.
        /// </summary>
        private const string FloatName = "float";

        /// <summary>
        /// The name of a <see cref="double"/> value.
        /// </summary>
        private const string DoubleName = "double";

        /// <summary>
        /// The name of a <see cref="string"/> value.
        /// </summary>
