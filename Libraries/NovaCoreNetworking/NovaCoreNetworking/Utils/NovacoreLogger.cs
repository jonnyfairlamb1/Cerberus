...
namespace NovaCoreNetworking.Utils {
    ...
    /// </summary>
    public class NovaCoreLogger {

        /// <summary>
        /// Whether or not <see cref="LogType.Debug"/> messages will be logged.
        /// </summary>
        public static bool IsDebugLoggingEnabled => logMethods.ContainsKey(LogType.Debug);

        /// <summary>
        /// Whether or not <see cref="LogType.Info"/> messages will be logged.
        /// </summary>
        public static bool IsInfoLoggingEnabled => logMethods.ContainsKey(LogType.Info);

        /// <summary>
        /// Whether or not <see cref="LogType.Warning"/> messages will be logged.
        /// </summary>
        public static bool IsWarningLoggingEnabled => logMethods.ContainsKey(LogType.Warning);

        /// <summary>
        /// Whether or not <see cref="LogType.Error"/> messages will be logged.
        /// </summary>
        ...
        /// <summary>
        /// Log methods, accessible by their <see cref="LogType"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes <see cref="NovaCoreLogger"/> with all log types enabled.
        /// </summary>
        ...
        /// <summary>
        /// Initializes <see cref="NovaCoreLogger"/> with the supplied log methods.
        /// </summary>
        ...
        public static void Initialize(LogMethod debugMethod, LogMethod infoMethod, LogMethod warningMethod, LogMethod errorMethod, bool includeTimestamps, string timestampFormat = "HH:mm:ss") {
            ...
            NovaCoreLogger.includeTimestamps = includeTimestamps;
            NovaCoreLogger.timestampFormat = timestampFormat;
        }

        /// <summary>
        /// Enables logging for messages of the given <see cref="LogType"/>.
        /// </summary>
        ...
        /// <summary>
        /// Disables logging for messages of the given <see cref="LogType"/>.
        /// </summary>
        /// <param name="logType">The type of message to enable logging for.</param>
