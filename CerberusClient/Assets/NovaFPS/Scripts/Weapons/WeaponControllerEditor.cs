        ...
        if (currentTab >= 0 || currentTab < tabs.Length) {
            switch (tabs[currentTab]) {
                case "Inventory":
                    ...
                    EditorGUILayout.LabelField("Attach your weapons ordered by their ID. These are not your initial weapons");
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("weapons"));
                    EditorGUILayout.LabelField("These are your initial weapons");
                    EditorGUILayout.Space(5);
                    ...
                    if (myScript.initialWeapons.Length == myScript.inventorySize) EditorGUILayout.LabelField("You can´t add more initial weapons. This array can´t be bigger than the inventory size");
                    break;
